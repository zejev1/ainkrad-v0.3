...
assert(report.numPassedTests>=286);assert.equal(audit.status,'passed');assert.equal(audit.base_commit,base);
...
execFileSync('git',['clone','--no-hardlinks','--no-checkout',root,target],{stdio:'pipe'});
...
writeFileSync(join(target,'docs','V0_3_21_FIX6_FILES.json'),JSON.stringify({base,sha256:hashes},null,2)+'\n');
